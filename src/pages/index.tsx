  ...
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      {!downloadPageLink && file && (
        <button className="p-2 my-5 w-44 bg-gray-900 rounded-md focus:outline-none" onClick={handleUpload}>{uploadState}</button>)}
        {downloadPageLink && (
          <div className="p-2 text-center">
            <DownloadFile downloadPageLink={downloadPageLink} />
            {/* <EmailForm id={id} /> */}
            <button className="p-2 my-5 w-44 bg-gray-900 rounded-md focus:outline-none" onClick={resetComponent}>
              Upload New File
            </button>
          </div>
        )}
